...
def shift_rows(state):
    state[1], state[5], state[9], state[13] = state[5], state[9], state[13], state[1]  # 2nd row shift
    state[2], state[6], state[10], state[14] = state[10], state[14], state[2], state[6]  # 3rd row shift
    state[3], state[7], state[11], state[15] = state[15], state[3], state[7], state[11]  # 4th row shift
    return state
...
if __name__ == "__main__":
    ...
    plain_text = "abcdefghijklmnoq"  # Must be 16 characters (128-bit block size)
